...
export type chanceItemDataStructure = [
...
@Component({
  selector: 'app-chance-item-data',
  templateUrl: './chance-item-data.component.html',
  styleUrls: ['./chance-item-data.component.scss']
})
export class ChanceItemDataComponent implements OnChanges {
  contentJson: string = "";
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: chanceItemDataStructure) => {
        // Write the opening tag for the item
        switch (this.type) {
          case 'ChanceItemData':
            xml += '	<object name="MiChanceItemData">\n';
            break;
          case 'EnchantInitializeData':
            xml += '  <object name="MiEnchantInitializeData">\n';
            break;
          case 'UnionItemsHelperData':
            xml += ' <object name="MiUnionItemsHelperData">\n';
            break;
          case 'EnchantPiercingData':
            xml += ' <object name="MiEnchantPiercingData">\n';
            break;
          case 'SlotInitializeData':
            xml += ' <object name="MiSlotInitializeData">\n';
            break;
        }
