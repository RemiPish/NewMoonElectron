import { Component, Output, ChangeDetectorRef, OnChanges, SimpleChanges, EventEmitter, Input } from '@angular/core';
...
@Component({
  selector: 'app-c-ura-field-data',
  templateUrl: './c-ura-field-data.component.html',
  styleUrls: ['./c-ura-field-data.component.scss']
})
export class CUraFieldDataComponent implements OnChanges {
  contentJson: string = "";
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: dataStructure) => {
        ...
        switch (this.type) {
          case 'CUraFieldData':
            xml += '	<object name="MiCUraFieldData">\n';
            break;
          case 'DevilBookBonusMitamaData':
            xml += '  <object name="MiDevilBookBonusMitamaData">\n';
            break;
          case 'DevilBookBonusData':
            xml += '  <object name="MiDevilBookBonusData">\n';
            break;
        }
