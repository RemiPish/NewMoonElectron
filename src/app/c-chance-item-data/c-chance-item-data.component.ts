...
@Component({
  selector: 'app-c-chance-item-data',
  templateUrl: './c-chance-item-data.component.html',
  styleUrls: ['./c-chance-item-data.component.scss']
})
export class CChanceItemDataComponent {
  contentJson: string = "";
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: cChanceItemDataStructure) => {
        ...
        xml += '	<object name="MiCChanceItemData">\n';
