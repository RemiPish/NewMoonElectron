...
export type triUnionKreuzItemDataStructure = [
...
@Component({
  selector: 'app-tri-union-kreuz-item-data',
  templateUrl: './tri-union-kreuz-item-data.component.html',
  styleUrls: ['./tri-union-kreuz-item-data.component.scss']
})
export class TriUnionKreuzItemDataComponent {
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: triUnionKreuzItemDataStructure) => {
        // Write the opening tag for the item
        xml += '	<object name="MiTriUnionKreuzItemData">\n';
