...
export type devilEquipmentItemDataStructure = [
  { name: 'itemID', value: number },
  { name: 'skillID', value: number },
];

@Component({
  selector: 'app-devil-equipment-item-data',
  templateUrl: './devil-equipment-item-data.component.html',
  styleUrls: ['./devil-equipment-item-data.component.scss']
})
export class DevilEquipmentItemDataComponent {
  contentJson: string = "";
  ...
  async parseData(json: string) {
    try {
      ...
      else items = [[{ name: "itemID", value: parsed.member.find((m: any) => m["@name"] === "itemID")["#text"] },
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: devilEquipmentItemDataStructure) => {
        // Write the opening tag for the item
        xml += '	<object name="MiDevilEquipmentItemData">\n';
