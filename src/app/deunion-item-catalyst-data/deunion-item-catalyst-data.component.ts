...
export type deunionItemCatalystDataStructure = [
...
@Component({
  selector: 'app-deunion-item-catalyst-data',
  templateUrl: './deunion-item-catalyst-data.component.html',
  styleUrls: ['./deunion-item-catalyst-data.component.scss']
})
export class DeunionItemCatalystDataComponent {
  contentJson: string = "";
  ...
  writeXmlFile(saveMode: string) {
    ...
    if (confirmation) {
      ...
      this.content.forEach((item: deunionItemCatalystDataStructure) => {
